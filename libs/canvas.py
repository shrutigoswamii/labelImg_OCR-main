...
class Canvas(QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self.drawing() and not self.prev_point.isNull() and not self.out_of_pixmap(self.prev_point):
            ...
            # print("At line 529 of canvas.py")
            # print(f"self.prev_point.x()={type(self.prev_point.x())}, {self.prev_point.x()}")
            # print(f"self.pixmap.height() = {type(self.pixmap.height())}, {self.pixmap.height()}")
            p.drawLine(int(self.prev_point.x()), 0, int(self.prev_point.x()), self.pixmap.height())

            # print("At line 530 of canvas.py")
            # print(f"self.prev_point.y()={type(self.prev_point.y())}, {self.prev_point.y()}")
            # print(f"self.pixmap.width() = {type(self.pixmap.width())}, {self.pixmap.width()}")
