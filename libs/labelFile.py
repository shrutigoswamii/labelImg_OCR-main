...
class LabelFile(object):
    ...
    def save_pascal_voc_format(self, filename, shapes, image_path, image_data,
        ...
        for shape in shapes:
            ...
            # NEW
            print("inside labelFile.py save_pascal_voc_format: shape - ", shape)
            ocr_text = shape.get('ocr_text', '')
            writer.add_bnd_box(bnd_box[0], bnd_box[1], bnd_box[2], bnd_box[3], label, difficult, ocr_text=ocr_text)
    ...
    def save_yolo_format(self, filename, shapes, image_path, image_data, class_list,
        ...
        for shape in shapes:
            ...
            # NEW
            print("inside labelFile.py save_yolo_format: shape - ", shape)
            ocr_text = shape.get('ocr_text', '')
            writer.add_bnd_box(bnd_box[0], bnd_box[1], bnd_box[2], bnd_box[3], label, difficult, ocr_text=ocr_text)
