...
class PascalVocWriter:
    ...
    def add_bnd_box(self, x_min, y_min, x_max, y_max, name, difficult, ocr_text=""):
        bnd_box = {
    ...
    def append_objects(self, top):
        for each_object in self.box_list:
            ...
            # New OCR text element
            ocr_text = SubElement(object_item, 'ocr_text')
            ocr_text.text = ustr(each_object.get('ocr_text', ''))
...
class PascalVocReader:
    ...
    def add_shape(self, label, bnd_box, difficult, ocr_text=""):
    ...
    def parse_xml(self):
        ...
        for object_iter in xml_tree.findall('object'):
            ...
            ocr_text_elem = object_iter.find('ocr_text')
            ocr_text = ocr_text_elem.text if ocr_text_elem is not None else ""
            # Add chris
            difficult = False
            if object_iter.find('difficult') is not None:
                difficult = bool(int(object_iter.find('difficult').text))
            self.add_shape(label, bnd_box, difficult,ocr_text)
        return True
